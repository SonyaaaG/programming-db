CREATE ROLE lab4_app LOGIN;

DROP DATABASE IF EXISTS lab4;

CREATE DATABASE lab4 ENCODING 'UTF-8' LC_COLLATE 'en_US.UTF-8' LC_CTYPE 'en_US.UTF-8' TEMPLATE template0 OWNER lab4_app;
\c lab4

CREATE SCHEMA lab4_app AUTHORIZATION lab4_app;

CREATE EXTENSION pgmemcache SCHEMA lab4_app;
